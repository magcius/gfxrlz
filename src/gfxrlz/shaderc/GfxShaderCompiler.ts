...
import { GfxVendorInfo, GfxProgramDescriptor, GfxDevice, GfxViewportOrigin, GfxClipSpaceNearZ } from "../platform/GfxPlatform.js";
...
interface GfxProgramDescriptorSimpleWithOrig extends GfxProgramDescriptor {
    vert: string;
    frag: string;
}

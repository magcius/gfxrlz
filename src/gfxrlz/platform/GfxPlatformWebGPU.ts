...
interface GfxProgramP_WebGPU extends GfxProgram {
    descriptor: GfxProgramDescriptor;
...
class GfxImplP_WebGPU implements GfxSwapChain, GfxDevice {
    ...
    constructor(public adapter: GPUAdapter, public device: GPUDevice, private canvas: HTMLCanvasElement | OffscreenCanvas, private canvasContext: GPUCanvasContext, private glsl_compile: null) {
...
export async function createSwapChainForWebGPU(canvas: HTMLCanvasElement | OffscreenCanvas): Promise<GfxSwapChain | null> {
    ...
    const glsl_compile = null; // rust.glsl_compile
